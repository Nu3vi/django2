...
from .models import Articulo, GrupoArticulo, LineaArticulo, ListaPrecio, Cliente, EstadoOrden, OrdenCompraCliente, \
...
def checkout(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            # Modificar en checkout dentro de core/views.py
